...
class FF45 extends \TAccountChecker
{
    ...
    public function InitBrowser()
    {
        ...
        //		$this->useSeleniumServer("selenium01.awardwallet.com");
        $this->useFirefox45();
        //		$this->usePacFile();
    ...
    public function Login()
    {
        ...
        $error = $this->waitForElement(\WebDriverBy::xpath("//span[contains(text(), 'Invalid user name or password')]"), 10, true)->getText();
